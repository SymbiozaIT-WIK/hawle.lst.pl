        ...
        <div class="col-md-6">
            <div class="error-template">
                ...
                <div class="error-actions">
                    <a href="<?php echo site_url(''); ?>" style="margin-top: 5px;" class="btn btn-info btn-sm">
                        Strona główna </a>
                    <a href="<?php echo site_url('panel'); ?>" style="margin-top: 5px;" class="btn btn-sm btn-primary">
                        Panel użytkownika</a>
                </div>
            </div>
        </div>
